class Vehiculo:
    ...
    # metodo: cumple la funcionalidad que una funcion pero con diferencia que solo
    ...
    def __chequeo_interno(self):
        # Encapsulamos este metodo para que solo pueda ser invocado dentro de la clase
        self.gasolina = 15
        self.aceite = 'Ok'
        self.temperatura = 40
